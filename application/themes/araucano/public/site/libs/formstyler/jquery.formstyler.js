						...
						function selectbox() {
							...
							function doSelect() {
								...
								var selectbox =
									$('<div' + att.id + ' class="jq-selectbox jqselect' + att.classes + '" style="display: inline-block; position: relative; z-index:' + opt.singleSelectzIndex + '">' +
											'<div class="jq-selectbox__select"' + att.title + ' style="position: relative">' +
												...
												'<div class="jq-selectbox__trigger"><div class="jq-selectbox__trigger-arrow"><i class="fa fa-angle-down"></i></div></div>' +
											'</div>' +
										'</div>');
								...
								if (opt.selectSearch) searchHTML =
									'<div class="jq-selectbox__search"><input type="text" class="form-input" autocomplete="off" placeholder="' + opt.selectSearchPlaceholder + '"></div>' +
