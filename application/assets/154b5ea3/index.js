...
function editTranslate(id)
{
    ...
    $('#original-text').html($('#orig-text-table-' + id).html());
    ...
    $.each($('span.translate-text'), function(){
        ...
        {
            $('#translate-form-' + $(this).attr('langalias')).val($(this).html());
        }
    });  

    //$('#translateForm').attr('action', $(this).attr('href'));
